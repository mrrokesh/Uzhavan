// Uzhavan — farmers listing harvests, drivers hauling them.
//
// This used to share a codebase with the buyer app (Uzhavan Buy), switched at
// build time via UZHAVAN_APP. The two are now independent projects (this
// folder and ../Uzhavanbuy), so the identity below is fixed rather than
// chosen by an env var.
//
...
// Uzhavan Buy on purpose — one dashboard, one set of credentials for what is
// one product. `scheme`, the Android package and the iOS bundle id stay
